...
export function TiptapEditor({ content, onChange }: TiptapEditorProps) {
    ...
    return (
        <div className="border border-[var(--muted)] rounded-lg overflow-hidden">
            <div className="border-b border-[var(--muted)] p-2 flex flex-wrap gap-1 bg-[var(--muted)]/30">
                <Button
                    type="button"
                    variant="ghost"
                    size="sm"
                ...
                <Button
                    ...
                    className={
                        editor.isActive("blockquote") ? "bg-[var(--accent)]/20" : ""
                    }
                >
                    <Quote className="h-4 w-4" />
                </Button>
                <div className="w-px h-6 bg-[var(--muted)] mx-1" />
                <Button
                    type="button"
                    variant="ghost"
                    size="sm"
